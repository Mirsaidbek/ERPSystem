...
public class LeaveRequest extends Auditable<Long> {
    ...
    public LeaveRequest(Long id, LocalDateTime createdAt, LocalDateTime updatedAt, Long createdBy, Long updatedBy, boolean deleted, String startDate, String endDate, LeaveRequestType leaveRequestType, LeaveRequestStatus leaveRequestStatus) {
